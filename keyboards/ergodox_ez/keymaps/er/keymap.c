...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(
    ...
    KC_LCTL,KC_TRANSPARENT,KC_TRANSPARENT,KC_LEFT,KC_RIGHT,
  ...
  [1] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT,KC_0,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TR(ANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT),
